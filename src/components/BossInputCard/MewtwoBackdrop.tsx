    ...
    <>
      ...
      <div aria-hidden className="absolute inset-0 z-10">
        {spriteX ? (
          ...
          <img src={spriteX} alt="" className="absolute left-[20%] top-0 h-full w-auto object-contain" />
        ) : null}
        {spriteY ? (
          // eslint-disable-next-line @next/next/no-img-element
          <img src={spriteY} alt="" className="absolute right-[20%] top-0 h-full w-auto object-contain" />
        ) : null}
      </div>
    </>
  );
