  ...
  return new ImageResponse(
    <div
      style={{
        ...
        padding: "64px 72px",
        background: "radial-gradient(1100px 600px at 18% -10%, #2a1248 0%, #0b0712 55%, #050507 100%)",
        color: "#f1f5f9",
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", width: 720 }}>
        ...
        >
          Exactly how many raids to max your XL Candy &amp; Mega Energy — including the debut of Mega Mewtwo X &amp; Y.
        </div>
