...
export const ESTIMATE_NOTES: EstimateNote[] = [
  ...
  },
  {
    ...
    confidence: "verified",
    note: "In-game pass screens (Jul 2026), rank-by-rank. Credits assume you finish the pass, minus ranks you've already claimed (set your rank in Assumptions); treating plain Mega Raids as below Tier 5 is our assumption.",
  },
  {
