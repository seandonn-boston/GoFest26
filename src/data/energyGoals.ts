...
export const ENERGY_GOALS: Record<string, EnergyGoalDef[]> = {
  kyurem: [
    // White & Black Kyurem are Dragon/Ice in GO (same as base Kyurem) — no added type.
    {
      key: "blaze",
      kind: "fusion",
      label: "Blaze · White Kyurem",
      flavor: "blaze",
      cost: 1000,
      perRaid: FUSION_PER_RAID,
      source: "White Kyurem",
      forme: "White",
      sprite: SOURCE_SPRITE.whiteKyurem,
      roadDayId: "tue",
    },
    {
      key: "volt",
      kind: "fusion",
      label: "Volt · Black Kyurem",
      flavor: "volt",
      cost: 1000,
      perRaid: FUSION_PER_RAID,
      source: "Black Kyurem",
      forme: "Black",
      sprite: SOURCE_SPRITE.blackKyurem,
      roadDayId: "wed",
    },
  ],
  necrozma: [
    {
      key: "lunar",
      kind: "fusion",
      label: "Lunar · Dawn Wings",
      flavor: "lunar",
      cost: 1000,
      perRaid: FUSION_PER_RAID,
      source: "Dawn Wings Necrozma",
      forme: "Dawn Wings",
      addedTypes: ["Ghost"],
      sprite: SOURCE_SPRITE.dawnWings,
      roadDayId: "tue",
    },
    {
      key: "solar",
      kind: "fusion",
      label: "Solar · Dusk Mane",
      flavor: "solar",
      cost: 1000,
      perRaid: FUSION_PER_RAID,
      source: "Dusk Mane Necrozma",
      forme: "Dusk Mane",
      addedTypes: ["Steel"],
      sprite: SOURCE_SPRITE.duskMane,
      roadDayId: "wed",
    },
  ],
  zacian: [
    {
      ...
      cost: 1000,
      perRaid: FUSION_PER_RAID,
      source: "Crowned Sword Zacian",
      forme: "Crowned",
      sprite: SOURCE_SPRITE.crownedSword,
      roadDayId: "thu",
    },
  ],
  zamazenta: [
    {
      ...
      cost: 1000,
      perRaid: FUSION_PER_RAID,
      source: "Crowned Shield Zamazenta",
      forme: "Crowned",
      sprite: SOURCE_SPRITE.crownedShield,
      roadDayId: "thu",
    },
  ],
  groudon: [
    {
      ...
      flavor: "primal",
      cost: 400,
      perRaid: PRIMAL_PER_RAID,
      source: "Primal Groudon",
      forme: "Primal",
      sprite: SOURCE_SPRITE.primalGroudon,
      roadDayId: "fri",
      note: PRIMAL_NOTE,
    },
  ],
  kyogre: [
    {
      ...
      cost: 400,
      perRaid: PRIMAL_PER_RAID,
      source: "Primal Kyogre",
      forme: "Primal",
      sprite: SOURCE_SPRITE.primalKyogre,
      roadDayId: "fri",
      note: PRIMAL_NOTE,
    },
  ],
